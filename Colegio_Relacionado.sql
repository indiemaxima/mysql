...
CREATE TABLE `alumnos` (
  ...
  `apellido` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `calificaciones` (
  ...
  UNIQUE KEY `calificaciones_idx` (`bimestre`,`idAlumnos`,`idMaterias`),
  KEY `FK_calificaciones_alumnos_idx` (`idAlumnos`),
  KEY `FK_calificaciones_materias_idx` (`idMaterias`),
  CONSTRAINT `FK_calificaciones_alumnos` FOREIGN KEY (`idAlumnos`) REFERENCES `alumnos` (`idAlumnos`) ON DELETE CASCADE,
  CONSTRAINT `FK_calificaciones_materias` FOREIGN KEY (`idMaterias`) REFERENCES `materias` (`idMaterias`) ON DELETE CASCADE
...
CREATE TABLE `datos_personales` (
  ...
  `acudiente` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`idDatos_Personales`),
  UNIQUE KEY `idAlumnos_UNIQUE` (`idAlumnos`),
  KEY `FK_datos_personales_alumnos_idx` (`idAlumnos`),
  CONSTRAINT `FK_datos_personales_alumnos` FOREIGN KEY (`idAlumnos`) REFERENCES `alumnos` (`idAlumnos`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `materias` (
  ...
  `nombre_Materia` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `profesor` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
